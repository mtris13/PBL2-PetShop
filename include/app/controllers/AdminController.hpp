...
private:
  ...
  void viewAllAccounts() {
    ...
    while (ad != nullptr) {
      cout << setw(8) << left << ad->getData().getId() << setw(25) << left
           << ad->getData().getName() << setw(10) << left
           << ad->getData().getGender() << "\n";
      ad = ad->getNext();
      count++;
    }
    ...
    while (staffNode != nullptr) {
      cout << setw(8) << left << staffNode->getData().getId() << setw(25)
           << left << staffNode->getData().getName() << setw(10) << left
           << staffNode->getData().getGender() << setw(15) << right << fixed
           << setprecision(0) << staffNode->getData().getSalary() << "\n";
    ...
    while (clientNode != nullptr) {
      cout << setw(13) << left
           << clientNode->getData().getId() // Giả sử Id là Phone
           << setw(25) << left << clientNode->getData().getName() << setw(10)
           << left << clientNode->getData().getGender() << setw(30) << left
           << clientNode->getData().getAddress() << "\n";
    ...
    if (length == AdminIdLength) { // Admin
      ...
      while (true) {
        ...
        try {
          ...
          std::cerr
              << "Error: Number is too large or too small. Please try again.\n";
        }
      }
  ...
  void displayPets(LinkedList<Dog> &dogList) {
    ...
    while (dog != nullptr) {
      cout << setw(6) << left << dog->getData().getId() << setw(12) << left
           << dog->getData().getStatus() << setw(15) << left
           << dog->getData().getName() << setw(20) << left
           << dog->getData().getBreed() << setw(3) << right
           << dog->getData().getAge() << setw(12) << right << fixed
           << setprecision(8) << dog->getData().getPrice() << setw(8) << right
           << dog->getData().getEnergyLevel() << "/10\n";
      dog = dog->getNext();
      dogCount++;
    }
  ...
  void displayPets(LinkedList<Cat> &catList) {
    ...
    while (cat != nullptr) {
      cout << setw(6) << left << cat->getData().getId() << setw(12) << left
           << cat->getData().getStatus() << setw(15) << left
           << cat->getData().getName() << setw(20) << left
           << cat->getData().getBreed() << setw(3) << right
           << cat->getData().getAge() << setw(12) << right << fixed
           << setprecision(0) << cat->getData().getPrice() << setw(8) << right
           << cat->getData().getFurLength() << "\n";
      cat = cat->getNext();
      catCount++;
    }
  ...
  void viewStatistics() {
    ...
    do {
      ...
      case 1: {
        ...
        int totalAll =
            counts.totalAdmin + counts.totalStaff + counts.totalClient;
      ...
      case 2: {
        ...
        cout << "  Total Available: "
             << (stats.availableDogs + stats.availableCats) << "\n";
